...
import com.chale.dark_strokes.R;
...
public class ArtSource extends RemoteMuzeiArtSource {
    ...
    private static final String ARTSOURCE_NAME = "darkstrokes";
    JSONObject jsonobject;

    private static final String JSON_URL = "https://github.com/chale22/DARK-STROKES-WALLS/blob/master/ds_walls.json";
